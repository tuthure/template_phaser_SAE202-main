...
export default class interfaceJeu extends Phaser.Scene {
    ...
    create() {
        ...
        */
        ...
        var liveSprite = this.add.sprite(0, 0, 'item_shoot').setOrigin(1, 0);
        ...
        if (this.objectives["collect_all_items"]) {
            this.itemText = this.add.text(650, 18, 'Morceaux de script récupérés : ' + this.playerProperties.itemsCollected + '/' + this.items_to_collect, { fontFamily: 'Arial', fontSize: 24, color: '#ffffff' });
        }
