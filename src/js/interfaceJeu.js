    ...
    create() {
        ...
        */
        ...
        if (this.objectives["collect_all_items"]) {
            this.itemText = this.add.text(650, 18, 'Morceaux de script collectés : ' + this.playerProperties.itemsCollected + '/' + this.items_to_collect, { fontFamily: 'Arial', fontSize: 24, color: '#ffffff' });
        }
